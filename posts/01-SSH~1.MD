...
*Running hydra against my own SSH login taught me that Wazuh doesn't have one brute-force rule, it has two, and which one fires depends on whether the username you're guessing actually exists.*
...
![Terminal showing hydra running twenty password attempts against a valid username, after an earlier run errored on a typo'd flag](../evidence/ssh-bruteforce/01-attack-hydra-rule-5763.png)
...
![Wazuh Threat Hunting table with the rule 5763 alert highlighted at rule.level 10](../evidence/ssh-bruteforce/5763.png)
...
![Terminal showing hydra running against the non-existent user fakeadmin](../evidence/ssh-bruteforce/02-attack-hydra-rule-5712.png)

![Wazuh Threat Hunting table with the rule 5712 alert highlighted, non-existent user brute-force](../evidence/ssh-bruteforce/5712.png)
