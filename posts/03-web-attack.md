...
![DVWA login page at localhost:8080](../evidence/web-dvwa/01-dvwa-running.png)
...
![the path traversal request, rule 31106, MITRE T1190](../evidence/web-dvwa/Screenshot%20From%202026-07-15%2000-46-10.png)

![the reflected XSS request, rule 31106](../evidence/web-dvwa/Screenshot%20From%202026-07-15%2000-46-21.png)

![the SQL injection request, rule 31106](../evidence/web-dvwa/Screenshot%20From%202026-07-15%2000-46-27.png)
